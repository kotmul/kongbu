...
from kongbu.train.skd.skd_config import SKDConfig
...
class SKDTrainer(Trainer):
    ...
    def _enable_gradient_checkpointing(self, model: PreTrainedModel, args: SKDConfig) -> PreTrainedModel:
                ...
                for name, param in self.model.named_parameters():
                    ...
                    with gather_if_zero3([param]):
                        if self.vllm_mode == "server" and self.accelerator.is_main_process:
                            ...
                            llm_model = self.llm.llm_engine.model_executor.driver_worker.worker.proposer_worker.model_runner.model
                            llm_model.load_weights([(name, param.data)])
